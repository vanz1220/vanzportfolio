...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Go to My Portfolio</a>		</p>
			</div>
...
/*  */
var _wpUtilSettings = {"ajax":{"url":"\/assessment\/wp-admin\/admin-ajax.php"}};
/*  */
</script>
<script type="text/javascript" src="./wp-includes/js/wp-util.min.js?ver=6.0" id="wp-util-js"></script>
<script type="text/javascript" id="user-profile-js-extra">
/*  */
var userProfileL10n = {"user_id":"0","nonce":"fc1ae992db"};
/*  */
</script>
